...
| Existing pool implementation | `bloom_lims/domain/beta_lab_stages.py::create_pool` already creates `material/pool/generic/1.0`, a pool tube, `contains` lineage, and `beta_pool_member` edges |
