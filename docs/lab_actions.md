...
### 3. Sequencing-Library Pool Tube
...
The wizard has four panels:

1. Extraction Plate.
2. Sequencing-Library Plate.
3. Sequencing Pool Tube.
4. Sequencing Run Set.

It also has a generic EUID print panel and an action-results panel. Successful actions populate downstream fields where possible, for example extraction plate EUID into the library plate step and pool tube/content EUIDs into the run-set step.
