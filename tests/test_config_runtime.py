...
def test_tapdb_version_contract_defaults_match_shipped_templates():
    ...
    assert settings.tapdb.min_version == "5.0.0"
    assert settings.tapdb.max_version_exclusive == "5.0.1"
    ...
    assert 'min_version: "5.0.0"' in root_template
    assert 'max_version_exclusive: "5.0.1"' in root_template
    assert 'min_version: "5.0.0"' in packaged_template
    assert 'max_version_exclusive: "5.0.1"' in packaged_template
