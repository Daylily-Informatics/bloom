...
def test_beta_flow_records_modern_action_instances(bdb):
    ...
    assert {
        ...
        ("RUN_CONSUMED", extraction_body["extraction_run_euid"], "workflow_run", specimen_euid, "consumed_material"),
        ("RUN_PRODUCED", extraction_body["extraction_run_euid"], "workflow_run", extraction_output_euid, "produced_material"),
        ("RUN_CONSUMED", pooling_run_euid, "workflow_run", library_material_euid, "consumed_material"),
        ("RUN_PRODUCED", pooling_run_euid, "workflow_run", pool_euid, "produced_material"),
        ("RUN_CONSUMED", run_euid, "workflow_run", pool_euid, "consumed_material"),
        ("RUN_CONSUMED", run_euid, "workflow_run", lib_output_euid, "consumed_artifact"),
        ("RUN_CONSUMED", run_euid, "workflow_run", library_material_euid, "consumed_material"),
        ("RUN_PRODUCED", run_euid, "workflow_run", artifact_euid, "produced_artifact"),
        ("SLOT_SATISFIED_BY", fulfillment_slot_ref, "fulfillment_slot", library_material_euid, "satisfying_bloom_object"),
