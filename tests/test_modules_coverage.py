...
class TestHealthModule:
    ...
    def test_component_health_model(self):
        ...
        component = ComponentHealth(
            name="database", status="healthy", latency_ms=5.2, message="Connected"
        )
    ...
    def test_liveness_response_model(self):
        ...
        response = LivenessResponse(status="ok", timestamp=datetime.now())
    ...
    def test_readiness_response_model(self):
        ...
        response = ReadinessResponse(
            status="ready", ready=True, timestamp=datetime.now()
        )
