...
|----------|--------|-------------|
| `/api/v1/objects/` | GET | List objects with filters (btype, b_sub_type, status, name_contains) |
...
| Endpoint | Method | Description |
|----------|--------|-------------|
| `/api/v1/containers/` | GET | List containers (filter by type, b_sub_type, status) |
